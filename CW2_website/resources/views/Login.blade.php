...
@section('main-content')
    <section id='login' class="flex flex-col w-full lg:w-1/2 mx-auto p-8 lg:p-10 rounded-2xl shadow-xl bg-white">
        ...
        <form class="flex flex-col" id="login_form" method="POST" action="user/dashboard">
            ...
            <p class="text-xs md:text-sm font-light text-black text-center">Don't have an accout yet? <a href="/signup" class="font-medium text-darkgreen hover:underline hover:font-bold">Sign Up</a></p>
        </form>
    </section>
@endsection