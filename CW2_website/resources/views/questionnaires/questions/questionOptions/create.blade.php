...
@section('main-content')
   <section id='create_question' class="flex flex-col w-full lg:w-1/2 mx-auto p-8 lg:p-10 rounded-2xl shadow-xl bg-white">
        ...
        <form class="flex flex-col" id="question_form" method="POST" action="{{ route('options.store', [$questionnaire->id, $question->id]) }}">
            @csrf
            ...
            <section class="py-2 m-2 flex justify-start content-center flex-wrap items-center">
                ...
                <label for="again" class="inline-block text-sm md:text-base align-middle self-center">Add another option</label>
            </section>
