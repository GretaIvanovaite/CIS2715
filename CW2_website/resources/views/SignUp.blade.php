...
@section('main-content')
    <section id='signup' class="flex flex-col w-full md:w-1/2 mx-auto p-8 md:p-10 rounded-2xl shadow-xl bg-white">
        ...
        <form class="flex flex-col">
            ...
            <button type="submit" class="cursor-pointer bg-brightgreen text-black font-semibold text-base uppercase rounded-lg p-2 hover:bg-darkgreen hover:text-white active:scale-95 transition-transform transform m-2 self-center min-w-1/5 max-w-9/10">Sign Up</button>
        </form>
    </section>
@endsection